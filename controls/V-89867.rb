...
describe pam('/etc/pam.d/common-password') do
  its('lines') { should match_pam_rule('password  required pam_cracklib.so') } #this is currently overly restrictive. Need to discuss if requisite is also acceptable. 
end
